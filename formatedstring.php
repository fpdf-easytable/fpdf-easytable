 ...
 **********************************************************************/
 class formatedString{
    ...
    private function get_style($str){
       $style=array('font-family'=>false, 'font-weight'=>false, 'font-style'=>false,'font-size'=>false, 'font-color'=>false);
   ...
   private function style_parcer($text, &$font_data){
      ...
      $tags=array('B', 'I');
         ...
         while($j!==false){
               if($tags[$i]=='B'){
               $open[$j]="font-weight:{$tags[$i]}";
                  }else{
                  $open[$j]="font-style:{$tags[$i]}";
               }
               $total[]=$j;
               $j=strpos($str, $lt, $j+1);
            }
      ...
      public function break_by_style($i, $j){
         $this->iterator=0;
         $result=array('chunks'=>array(), 'style'=>array(), 'height'=>0);
